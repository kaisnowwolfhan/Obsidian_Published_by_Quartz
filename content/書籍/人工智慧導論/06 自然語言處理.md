...
## 詞性標記
為掌握詞彙的特性，通常會把特性類似的詞彙聚在一起，並給予相同的類別，稱為 **詞性**。
...
詞彙和詞彙之間以*有向的* 箭頭鏈結，上方標示兩詞彙的相依關係。
...
> ![兩個表示如何比較和評分─06_自然語言處理|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/兩個表示如何比較和評分─06_自然語言處理.jpg)
> - - -
...
> \end{align}
> $$
> ![兩個表示如何比較和評分─06_自然語言處理_3|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/兩個表示如何比較和評分─06_自然語言處理_3.jpg)
> ![兩個表示如何比較和評分─06_自然語言處理_1|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/兩個表示如何比較和評分─06_自然語言處理_1.jpg)
> 最後，以 Stanford CoreNLP 檢視小明的問句以及 $A_{4-2}$ 和 $A_{5-2}$ 這兩答案的意思，並進行相依剖析。
> ![兩個表示如何比較和評分─06_自然語言處理_2|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/兩個表示如何比較和評分─06_自然語言處理_2.jpg)
> 結果摘要如下：
...
![6-4_資料庫規模和效率─06_自然語言處理|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/6-4_資料庫規模和效率─06_自然語言處理.jpg)
...
![6-5_以深度學習實現「平行時空之師」─06_自然語言處理|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/6-5_以深度學習實現「平行時空之師」─06_自然語言處理.jpg)

> [!info] 詞向量
> 即每個詞都用一個向量表示(vector representaion)，如此便能將句子切成數個詞向量以數值化，並送入模型處理

如同詞向量可表示一個詞彙，句子也可用句子向量表示。
![6-5_以深度學習實現「平行時空之師」─06_自然語言處理_1|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/6-5_以深度學習實現「平行時空之師」─06_自然語言處理_1.jpg)
...
![6-5_以深度學習實現「平行時空之師」─06_自然語言處理_2|500](https://raw.githubusercontent.com/kaisnowwolfhan/Obsidian-Images/refs/heads/master/6-5_以深度學習實現「平行時空之師」─06_自然語言處理_2.jpg)
