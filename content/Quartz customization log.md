...
That said，[匯入 quartz5-drawer](https://bf60c891.quartz-1h4.pages.dev/cli/plugin#add) 後，決定好你要放的位置，然後記得在 layout 加上 `display: modile-only` 。我是選擇放在 Reader-mode button 的右邊，以下
`quartz.config.yaml`
```yaml
