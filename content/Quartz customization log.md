...
> 	options.showGithubTracer && options.repoLink && filePath && (!isIndexPage || options.inIndex);
> return (
> 	<div class="github-tracer">
> 		{showSourceLinks && (
...
> 				href={`${options.repoLink}/blob/${options.branch}/${filePath}`}
> 				ᨒ Source ᨒ
> 			  </a>
> 			  <a
> 				class="external"
> 				target="_blank"
> 				rel="noopener noreferrer"
> 				href={`${options.repoLink}/blame/${options.branch}/${filePath}`}
> 				↟ Blame ᨒ
> 			  </a>
> 			  <a
> 				class="external"
> 				target="_blank"
> 				rel="noopener noreferrer"
> 				href={`${options.repoLink.replace(
> 				  "github.com",
> 				  "github.githistory.xyz",
> 				)}/commits/${options.branch}/${filePath}`}
> 				↟ GitHistory ↟
> 			  </a>
> 			</p>
> 			)}
